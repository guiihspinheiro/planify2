...
/**
 * O model tem como objetivo criar a tabela de banco de dados e definir as
 * principais variáveis de cada item dentro do software.
 */
...
public class UserModel {
    // Parametros de @Id e @GeneratedValue indicam que a variável que está abaixo é
    // uma coluna chave primária e será gerada automaticamente usando UUID
    @Id
